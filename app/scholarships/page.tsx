import { getScholarships, ScholarshipFilters } from "@/app/scholarships/actions"
import { Navbar } from "@/components/Navbar"
import { ScholarshipBoardFilters } from "@/components/scholarships/ScholarshipBoardFilters"
...
export const metadata = {
  title: "Scholarship Board | cvmyjob — Curated Opportunities",
  description: "Hand-picked scholarships and financial aid opportunities.",
  openGraph: {
    title: "Scholarship Board | cvmyjob — Curated Opportunities",
    description: "Hand-picked scholarships from top providers, vetted by the cvmyjob team.",
    images: [{
      url: '/logo.png',
      width: 1200,
      height: 630,
      alt: 'cvmyjob Scholarship Board'
    }],
    type: 'website',
  },
  twitter: {
    card: 'summary_large_image',
    title: "cvmyjob Scholarship Board",
    description: "Apply to premium, hand-picked scholarships on the cvmyjob Board.",
    images: ['/logo.png'],
  }
}
        ...
        <div className="relative text-center space-y-10 max-w-4xl mx-auto">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-brand-action/10 border border-brand-action/20 rounded-full text-[10px] font-black uppercase tracking-[0.3em] text-brand-action">
              ...
              CVMyJob Scholarship Board
            </div>
            <h1 className="text-5xl lg:text-7xl font-black tracking-tight leading-none">
              Fund Your Future <br /> <span className="text-brand-action">Big Opportunity</span>
            </h1>
            <p className="text-foreground/50 text-base md:text-lg font-bold leading-relaxed max-w-2xl mx-auto">
              Verified scholarships and financial aid from elite providers, indexed daily. Every opportunity is vetted by our team.
            </p>
          </div>
          {/* Background glow */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <aside className="lg:col-span-3 space-y-8">
            <div className="sticky top-28 bg-card border border-border-custom rounded-[32px] p-6 shadow-xl">
               <ScholarshipBoardFilters initialFilters={filters} />
            </div>
          </aside>
          ...
          <div className="lg:col-span-9 space-y-8">
            ...
            <div className="flex items-center justify-between px-6">
              <h2 className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">
                Showing {scholarships.length} verified listings
              </h2>
            </div>
                      ...
                      <div className="flex-1 space-y-3 min-w-0">
                        ...
                        <div className="flex flex-wrap items-center gap-x-6 gap-y-1.5 text-sm font-bold text-foreground/50">
                          ...
                          <span className="flex items-center gap-2 opacity-50">
                            <Clock size={14} />
                            {scholarship.postedAt ? formatDistanceToNow(new Date(scholarship.postedAt), { addSuffix: true }) : 'Recently'}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-3 shrink-0 w-full md:w-auto pt-4 md:pt-0 border-t md:border-t-0 border-border-custom relative z-10">
                        <CopyBriefButton 
                          jobData={{
                            ...
                            url: `${typeof window !== 'undefined' ? window.location.origin : ''}/scholarships?selected=${scholarship.id}`,
      ...
      <footer className="border-t border-border-custom py-10 px-6 mt-20">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="text-[10px] font-black uppercase tracking-[0.2em] text-foreground/20">
            © 2026 CVMyJob — Premium Scholarship Hub
          </p>
