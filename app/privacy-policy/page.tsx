        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-16">
            ...
            <div className="flex items-center space-x-4 mb-6">
              ...
              <h1 className="text-4xl md:text-5xl font-black tracking-tight text-foreground">
                Privacy <span className="text-brand-action">Policy</span>
              </h1>
            </div>
            <div className="flex items-center space-x-2 text-muted-foreground font-medium">
              ...
              <span>Your data security is our priority</span>
          ...
          <motion.div variants={itemVariants} className="prose prose-premium max-w-none">
            <p className="text-xl text-foreground/80 leading-relaxed mb-8 font-medium">
              At CV My Job, your privacy is fundamental to our mission. This policy details how we handle your personal data when you use our CV crafting tools.
            </p>
            ...
            >
              <p className="m-0 text-foreground/70 italic">
                We believe in total transparency. We only collect the information necessary to provide you with the best professional document creation experience possible.
              </p>
            </motion.div>

            <h2 className="text-2xl font-black text-foreground mt-12 mb-6 uppercase tracking-wider">Information Collection</h2>
            <p className="text-foreground/80 leading-relaxed">We collect several types of information for various purposes to provide and improve our Service to you.</p>
            
            <h3 className="text-xl font-bold text-foreground mb-4">Personal Data</h3>
            <p className="text-foreground/80 leading-relaxed">While using our Service, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you ("Personal Data"). This includes, but is not limited to:</p>
            <ul className="space-y-2 text-foreground/80 list-disc pl-6 mb-8">
              <li>Email address</li>
              <li>First name and last name</li>
              <li>Professional history and educational background (provided by you for CV generation)</li>
              <li>Cookies and Usage Data</li>
            </ul>

            <h2 className="text-2xl font-black text-foreground mt-16 mb-6 uppercase tracking-wider">Use of Data</h2>
            <p className="text-foreground/80 leading-relaxed">CV My Job uses the collected data for various purposes:</p>
            <ul className="space-y-4 text-foreground/80 list-disc pl-6 mb-8">
            ...
            <h2 className="text-2xl font-black text-foreground mt-16 mb-6 uppercase tracking-wider">Data Security</h2>
            ...
            <div className="mt-8 flex flex-col md:flex-row items-center p-8 bg-brand-primary dark:bg-brand-action/10 text-white dark:text-foreground rounded-[2.5rem] shadow-2xl overflow-hidden relative group border dark:border-brand-action/20">
              ...
              <div className="text-center md:text-left relative z-10">
                <p className="text-xs font-black uppercase tracking-[0.3em] text-white/50 dark:text-brand-action mb-2">Have privacy concerns?</p>
