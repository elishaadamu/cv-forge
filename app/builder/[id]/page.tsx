      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 pt-24 pb-10">
        <div className="flex flex-col lg:flex-row gap-8 h-full min-h-[calc(100vh-140px)]">
          ...
          >
             ...
             <div className={`flex-1 w-full overflow-auto bg-slate-100/5 custom-scrollbar relative z-10 flex justify-center py-10 px-4 ${isPreview ? "pb-24" : ""}`}>
                <div className={`w-full max-w-[850px] origin-top transition-transform duration-500 scale-[0.4] xs:scale-[0.5] sm:scale-75 md:scale-[0.85] lg:scale-[0.75] xl:scale-95 ${isPreview ? "scale-[0.4] xs:scale-[0.55] sm:scale-100 mt-4 mb-20" : "scale-90"}`}>
                   {renderTemplate()}
                </div>
             </div>
