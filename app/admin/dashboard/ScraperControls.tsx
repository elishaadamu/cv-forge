...
import { RefreshCw, Play, CheckCircle2, AlertCircle, Loader2, Sparkles, GraduationCap } from "lucide-react"
import { runScholarshipScraperAction, runScholarshipRegionScraperAction } from "./actions"
      ...
      <div className="relative z-10 space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-xs font-bold leading-relaxed max-w-md">
            Trigger deep-web crawlers to refresh scholarship opportunities and graduate programs from indexed sources.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <div className="text-left space-y-1">
              ...
              <p className="text-sm font-black text-foreground">Update Graduate Programs</p>
            </div>
          </button>
          ...
          >
            ...
            <div className="text-left space-y-1">
              ...
              <p className="text-sm font-black text-foreground">Update Global Scholarships</p>
            </div>
          </button>
        </div>
