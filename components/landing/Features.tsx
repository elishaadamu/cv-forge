        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="space-y-4 max-w-2xl">
            ...
            <p className="text-foreground/50 text-xl font-medium max-w-xl">
              We've integrated state-of-the-art AI to handle the complexity, so you can focus on your career move.
            </p>
          </div>
          <motion.div 
            ...
            className="shrink-0"
          >
            <Link href="/features" className="px-8 py-4 glass border border-border-custom rounded-2xl font-black flex items-center gap-2 hover:bg-foreground/5 transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((f, i) => (
            <motion.div 
              ...
              className="p-10 glass border border-border-custom rounded-[48px] space-y-8 group hover:border-brand-action/30 transition-all duration-500 shadow-sm hover:shadow-xl hover:shadow-brand-action/5"
            >
