...
const SCHOLARSHIP_TYPES = ["Merit-Based", "Need-Based", "Athletic", "Student-Specific", "Career-Specific", "College-Specific"]

export function ScholarshipBoardFilters({ initialFilters }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <label className="text-[9px] font-bold uppercase tracking-widest text-foreground/40 pl-2">Scholarship Type</label>
          <div className="relative">
            <button
